...
name_cpu = f'pickle/ac-fft-pySDC-cpu.pickle'
name_gpu = 'pickle/ac-fft-pySDC-gpu.pickle'
...
plt.grid()
# savefig('pdfs/ac-fft-ndtype', save_pgf=False, save_png=False)
# plt.show()
plt.clf()
...
plt.legend(bbox_to_anchor=(1.04, 0.5), loc="center left")
plt.grid()
savefig('pdfs/ac-fft-factor-ndytpe', save_pgf=False, save_png=False)
# plt.show()
plt.clf()
...
fig.tight_layout()
# plt.show()
savefig('pdfs/ac-fft-times-ndtype', save_pgf=False, save_png=False)
plt.clf()
