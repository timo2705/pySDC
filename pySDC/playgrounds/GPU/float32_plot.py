...
with open(name, 'rb') as f:
    data = pickle.load(f)
Ns = data['Ns']
times_cpu_16 = data['times-cpu-16']
times_gpu_16 = data['times-gpu-16']
times_cpu_32 = data['times-cpu-32']
times_gpu_32 = data['times-gpu-32']
times_cpu_64 = data['times-cpu-64']
times_gpu_64 = data['times-gpu-64']

plt.plot(Ns, times_cpu_16, color="green", ls=":", label="float16 CPU")
plt.plot(Ns, times_gpu_16, color="green", ls="-", label="float16 GPU")
